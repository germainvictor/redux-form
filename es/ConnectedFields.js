  ...
  var ConnectedFields = /*#__PURE__*/ (function(_React$Component) {
    ...
    _proto.render = function render() {
      ...
      var _this$props4 = this.props,
        ...
        rest = _objectWithoutPropertiesLoose(_this$props4, _excluded)
      ...
      var _Object$keys$reduce = Object.keys(_fields).reduce(function(accumulator, name) {
          ...
          var _createFieldProps = createFieldProps(
            ...
            fieldProps = _objectWithoutPropertiesLoose(_createFieldProps, _excluded3)
        ...
        props = _objectWithoutPropertiesLoose(_Object$keys$reduce, _excluded2)

      if (forwardRef) {
        props.ref = this.ref
      }

      return /*#__PURE__*/ React.createElement(component, _extends({}, props, custom))
    }
